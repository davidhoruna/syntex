  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex flex-col">
      <div className="flex items-start justify-between mb-2">
        ...
        <button
          className="text-zinc-400 hover:text-red-400 p-1 rounded-full hover:bg-zinc-800"
      ...
      <div className="mt-4 text-right">
        <Link
          href={`/math/learn/${encodeURIComponent(topic.name)}?difficulty=${topic.difficulty}&language=en&topicId=${
            topic.id
          }`}
          className="inline-flex items-center text-zinc-400 hover:text-white px-2 py-1 rounded hover:bg-zinc-800"
        >
          Continue
